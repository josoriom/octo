...
#[test]
fn tiny2_srm_mzml0_99_1_b64_s101_mz_binary_payload() {
    let mzml = parse_b(&MZML_CACHE, PATH);
    let run = &mzml.run;
...
#[test]
fn tiny2_srm_mzml0_99_1_b64_s101_intensity_binary_payload() {
    let mzml = parse_b(&MZML_CACHE, PATH);
    let run = &mzml.run;
...
#[test]
fn tiny2_srm_mzml0_99_1_b64_s102_mz_binary_payload() {
    let mzml = parse_b(&MZML_CACHE, PATH);
    let run = &mzml.run;
...
#[test]
fn tiny2_srm_mzml0_99_1_b64_s102_intensity_binary_payload() {
    let mzml = parse_b(&MZML_CACHE, PATH);
    let run = &mzml.run;
