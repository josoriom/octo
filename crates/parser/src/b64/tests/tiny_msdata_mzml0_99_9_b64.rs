...
#[test]
fn tiny_msdata_mzml0_99_9_s19_mz_binary() {
    let mzml = mzml_cached();
    let run = &mzml.run;
...
#[test]
fn tiny_msdata_mzml0_99_9_s19_intensity_binary() {
    let mzml = mzml_cached();
    let run = &mzml.run;
...
#[test]
fn tiny_msdata_mzml0_99_9_s20_mz_binary() {
    let mzml = mzml_cached();
    let run = &mzml.run;
...
#[test]
fn tiny_msdata_mzml0_99_9_s20_intensity_binary() {
    let mzml = mzml_cached();
    let run = &mzml.run;
