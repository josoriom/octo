...
| 172    | 1    | `compression_codec`             | u8      | Compression method (0=none/uncompressed, 1=zstd)              |
...
| 179    | 5    | `reserved`                      | u8[5]   | Reserved                                                      |
| 184    | 8    | `size_spec_meta_uncompressed`   | u64     | Uncompressed byte size of Section C (Spectrum Metadata).      |
| 192    | 8    | `size_chrom_meta_uncompressed`  | u64     | Uncompressed byte size of Section D (Chromatogram Metadata).  |
| 200    | 8    | `size_global_meta_uncompressed` | u64     | Uncompressed byte size of Section E (Global Metadata).        |
| 208    | 304  | `reserved_ext`                  | u8[304] | Reserved                                                      |
...
- `MRI, MTI, MAN, MURI, MUAN, VK, VI` each have `meta_count` elements
