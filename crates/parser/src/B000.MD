...
| 16     | 8    | `len_spec_entries`                | u64     | **On-disk byte length** of Section A.                           |
| 24     | 8    | `off_spec_arrayrefs`              | u64     | Byte offset to Section A1 (Spectrum ArrayRef).                  |
| 32     | 8    | `len_spec_arrayrefs`              | u64     | **On-disk byte length** of Section A1.                          |
| 40     | 8    | `off_chrom_entries`               | u64     | Byte offset to Section B (Chromatogram Entries).                |
| 48     | 8    | `len_chrom_entries`               | u64     | **On-disk byte length** of Section B.                           |
| 56     | 8    | `off_chrom_arrayrefs`             | u64     | Byte offset to Section B1 (Chromatogram ArrayRef).              |
| 64     | 8    | `len_chrom_arrayrefs`             | u64     | **On-disk byte length** of Section B1.                          |
| 72     | 8    | `off_spec_meta`                   | u64     | Byte offset to Section C (Spectrum Metadata).                   |
| 80     | 8    | `len_spec_meta`                   | u64     | **Compressed (on-disk) byte length** of Section C.              |
| 88     | 8    | `off_chrom_meta`                  | u64     | Byte offset to Section D (Chromatogram Metadata).               |
| 96     | 8    | `len_chrom_meta`                  | u64     | **Compressed (on-disk) byte length** of Section D.              |
| 104    | 8    | `off_global_meta`                 | u64     | Byte offset to Section E (Global Metadata).                     |
| 112    | 8    | `len_global_meta`                 | u64     | **Compressed (on-disk) byte length** of Section E.              |
| 120    | 8    | `off_container_spect`             | u64     | Byte offset to the Spectrum container.                          |
| 128    | 8    | `len_container_spect`             | u64     | **Compressed (on-disk) byte length** of the Spectrum container. |
| 136    | 8    | `off_container_chrom`             | u64     | Byte offset to the Chrom container.                             |
| 144    | 8    | `len_container_chrom`             | u64     | **Compressed (on-disk) byte length** of the Chrom container.    |
...
| 232    | 8    | `spec_meta_uncompressed_bytes`    | u64     | Uncompressed byte size of Section C (Spectrum Metadata).        |
| 240    | 8    | `chrom_meta_uncompressed_bytes`   | u64     | Uncompressed byte size of Section D (Chromatogram Metadata).    |
| 248    | 8    | `global_meta_uncompressed_bytes`  | u64     | Uncompressed byte size of Section E (Global Metadata).          |
